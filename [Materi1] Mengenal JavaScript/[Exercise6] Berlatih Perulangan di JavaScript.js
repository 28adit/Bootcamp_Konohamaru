...
console.log('LOOPING PERTAMA')
  var flag = 2;
  while(flag < 21) { // Loop akan terus berjalan selama nilai flag masih diatas 1
...
var flagi = 20;
while(flagi > 0) { // Loop akan terus berjalan selama nilai flag masih dibawah 20
  console.log(flagi + ' - I will become fullstack developer' ); // Menampilkan nilai flag pada iterasi tertentu
  flagi-=2; // Mengubah nilai flag dengan mengurangi 2
}
